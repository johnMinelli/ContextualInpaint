...
if __name__ == "__main__":
    prompt="follow this example of caption 'a man sitting in the driver's seat of a car' and provide a COMPACT and OBJECTIVE caption for the action currently performed by the driver if DISTRACTED, using OBJECTS or ATTENTIVE to the street"
    image_file = "/media/data4TB/gio/ctrl/data/verizon_formatted/target/event_video_dfc (2)/frame_67.jpg"
